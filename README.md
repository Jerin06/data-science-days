...
- [DeepLearning.AI Specializations](https://www.coursera.org/deeplearning-ai)
- [Python for Everybody Specialization – Michigan](https://www.coursera.org/specializations/python)
...
- [Fat Chance: Probability from the Ground Up – HarvardX](https://www.edx.org/course/fat-chance-probability-from-the-ground-up-2)
- [Probability: Basic Concepts & Discrete Random Variables](https://www.edx.org/course/probability-basic-concepts-discrete-random-variabl)
- [Probability: Distribution Models & Continuous Random Variables](https://www.edx.org/course/probability-distribution-models-continuous-random)
- [Introduction to Probability – HarvardX](https://www.edx.org/course/introduction-to-probability)
- [Computational Probability and Inference – MITx](https://www.edx.org/course/computational-probability-and-inference)
